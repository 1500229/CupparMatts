/**************************************************************
	...
	Script		    : multiBox
	Version		    : 1.6.1
	Original author	: Samuel Birch
    Modified by	    : Liam Smart (liam_smart@hotmail.com) - MooTools 1.2 & 1.6 compatibility and extra features
	...
	Usage		    : window.addEvent('domready', function(){
					    ...
					    var initMultiBox = new multiBox({
						    ...
						    addDownload: true,//makes media downloadable - only use when website hosted on Windows/ASP server
...
var multiBox = new Class({
	...
	start: function(){
		...
		this.multiBox.each(function(el){
			//check rel contains a group - [group] will fail W3C validation
			if(el.rel.test(/\[*?]/i)){
        ...
        //create all the wee elements for bottom of the pop-up
	...
	getContent: function(element){
		...
		this.contentToLoad = {
			title: element.retrieve('origTitle') || '&nbsp',
			desc: desc,
			number: this.index+1
		}
	},
	...
	showControls: function(){
		...
		//alert(this.controls.getStyle('height'))
